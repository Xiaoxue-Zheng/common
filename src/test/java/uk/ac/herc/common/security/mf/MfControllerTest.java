...
public class MfControllerTest {
    ...
    @Test
    public void validateAndAuthSuccessAndCreateJwtToken(){
        String code = generateAndNoSend("test");
        MfAuthDTO mfAuthDTO = new MfAuthDTO();
        mfAuthDTO.setUserName("test");
        mfAuthDTO.setPassword("password");
        ...
        ResponseEntity<MfController.JWTToken> authenticate = mfController.authenticate(mfAuthDTO);
        assertThat(authenticate.getBody().getIdToken()).isNotNull();
    }
